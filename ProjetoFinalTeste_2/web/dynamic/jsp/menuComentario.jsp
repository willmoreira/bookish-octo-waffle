            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <ul style="list-style-type:none">
                        <li><label class="busca" for="idPost"></label>
                        </li>  
                        ...
                        <li>
                            <div class="checkbox">
                                ...
                                <div class="form-group">
                                     <button id= "for-block1" type="submit" class="btn btn-default" name="btn" value="inserir">INSERIR</button>
                                </div>
                           </div>   
                        </li>
                        <li> 
                            <div class="checkbox">
                                <div class="form-group">
                                     <button id= "for-block1" type="submit" class="btn btn-default" name="btn" value="deletar">DELETAR</button>
                                </div>
                           </div>   
                        </li> 
                        <li>                                 
                            <div class="checkbox">
                                <div class="form-group">
                                     <button id= "for-block1" type="submit" class="btn btn-default" name="btn" value="buscar">BUSCAR</button>
                                </div>
                           </div>   
                        </li>
                        <li>
                           <div class="checkbox">
                                <div class="form-group">
                                    <button id= "for-block1" type="submit" class="btn btn-default" name="btn" value="refazer">REFAZER</button>
                                </div>
                           </div>   
