                ...
                <div class="navbar-header">
                   ...
                   <form action="deleteComentario">
                    <ul style="list-style-type:none">
                        <li><label class="busca" for="idPost">ID COMENTARIO</label>
                         <input type="text" class="form-control" id="nome1" placeholder="ID DO COMENTARIO" name="idcomentario">
                        </li>                                    
                        
                        <li>
                           <div class="checkbox">
                                <div class="form-group">
                                     <button id= "for-block1" type="submit" class="btn btn-default" name="deletarbtn" value="deletar">DELETAR COMENTARIO</button>
                                </div>
                           </div>   
