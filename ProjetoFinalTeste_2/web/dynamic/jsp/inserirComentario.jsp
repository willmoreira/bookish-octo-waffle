...
<html>
    ...
    <body>
        <div class="header">
            <h1>INSIRA OS DADOS DO SEU COMENTARIO</h1>
        </div>
                ...
                <div class="navbar-header">
                    ...
                    <ul style="list-style-type:none">
                        ...
                        <li>                                 
                            ...
                            <input type="text" class="form-control" id="pwd1" placeholder="ID do usuario" name="iduser">
                        </li>
                        <li>
                           <div class="checkbox">
                                <div class="form-group">
                                     <button id= "for-block1" type="submit" class="btn btn-default" name="inserirbtn">INSERIR COMENTARIO</button>
                                </div>
                           </div>   
